...
class InMemoryTaskManagerTest {
    ...
    // Анна, такой тест: "проверьте, что задачи с заданным id и сгенерированным id не конфликтуют внутри менеджера",
    // наверное, невозможно сделать, потому что я в принципе не могу добавлять задачи с заданным id,
    // такое не предусмотрено ни одним конструктором?
}